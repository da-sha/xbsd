...
--
INSERT INTO `config` VALUES ('0','3','瑞特瑞特让他','梵蒂冈的风格','萨达速度','0');
...
INSERT INTO `config` VALUES ('4','1','site_email','站点邮箱','admin@yourphp.cn','1');
INSERT INTO `config` VALUES ('5','1','seo_title','网站标题','yourphp企业网站管理系统-企业建站-企业网站-行业网站建设-门户网站建设','1');
INSERT INTO `config` VALUES ('6','1','seo_keywords','关键词','西北师大教务支持系统速度发生的','1');
INSERT INTO `config` VALUES ('7','1','seo_description','网站简介','西北师大教务支持系统23阿斯达撒旦','1');
INSERT INTO `config` VALUES ('15','4','attach_maxsize','允许上传附件大小','5200000','0');
INSERT INTO `config` VALUES ('16','4','attach_allowext','允许上传附件类型','jpg,jpeg,gif,png,doc,docx,rar,zip,swf','0');
INSERT INTO `config` VALUES ('17','4','watermark_enable','是否开启图片水印','1','0');
INSERT INTO `config` VALUES ('19','4','watemard_text_size','文字大小','18','0');
INSERT INTO `config` VALUES ('21','4','watemard_text_face','字体','elephant.ttf','0');
INSERT INTO `config` VALUES ('22','4','watermark_minwidth','图片最小宽度','300','0');
INSERT INTO `config` VALUES ('46','3','member_register','允许新会员注册','1','1');
INSERT INTO `config` VALUES ('48','3','member_registecheck','新会员注册需要审核','1','1');
INSERT INTO `config` VALUES ('49','3','member_login_verify','注册登陆开启验证码','1','1');
INSERT INTO `config` VALUES ('53','2','allow_add_graduation_thesis_title','允许添加毕业论文选题','1','1');
INSERT INTO `config` VALUES ('54','2','allow_add_term_thesis_title','允许添加学年论文选题','1','1');
INSERT INTO `config` VALUES ('55','2','autumn_semester','秋季学期','2','1');
INSERT INTO `config` VALUES ('56','2','default_start_week','默认起始授课周','1','1');
INSERT INTO `config` VALUES ('57','2','default_teach_week','默认授课周数','18','1');
INSERT INTO `config` VALUES ('58','2','graduation_thesis','毕业论文','2','1');
INSERT INTO `config` VALUES ('59','2','not_limit_major','不限专业','6','1');
INSERT INTO `config` VALUES ('60','2','role_type_teacher','教室角色','4','1');
INSERT INTO `config` VALUES ('61','2','spring_semester','春季学期','1','1');
INSERT INTO `config` VALUES ('62','2','term_thesis','学年论文','1','1');
INSERT INTO `config` VALUES ('63','2','thesis_result_failed','论文审核未通过','3','1');
INSERT INTO `config` VALUES ('64','2','thesis_result_pass','论文审核通过','2','1');
INSERT INTO `config` VALUES ('65','2','thesis_result_wait','论文待审核','1','1');
INSERT INTO `config` VALUES ('66','2','thesis_title_assign_teacher_model','论文题目指定教师模式','2','1');
INSERT INTO `config` VALUES ('67','2','thesis_title_free_select_model','论文题目自由选题模式','1','1');
INSERT INTO `config` VALUES ('68','2','user_title_select_model','使用的论文选题模式','1','1');
INSERT INTO `config` VALUES ('71','2','not_limit_admission','不限年级','0','1');
INSERT INTO `config` VALUES ('1221','1','test','测试','1撒旦','0');
--
-- 表的结构 `course`
-- 
...
) ENGINE=InnoDB AUTO_INCREMENT=170 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 COMMENT='菜单';
...
--
INSERT INTO `teach_task` VALUES ('1','5','1','2012','1','1','18',NULL,'1',NULL,'C++ primer','人民邮电出版社','stanley B.lippman','2012-11-01','5','2','1',NULL,NULL,NULL,NULL,'2',NULL,'5','2012-11-06');
...
INSERT INTO `teach_task` VALUES ('104','6','48','2013','1','1','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3',NULL,'9','2012-10-27');
