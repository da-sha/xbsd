...
INSERT INTO `class` VALUES ('2','计算机科学与技术（非师范）1班','7','7','30','5','2009',NULL,NULL,NULL);
INSERT INTO `class` VALUES ('3','计算机科学与技术（师范）1班','6','6','60','1','2012',NULL,NULL,NULL);
INSERT INTO `class` VALUES ('4','物联网班','6','6','30','4','2010',NULL,NULL,'2012-10-11');
INSERT INTO `class` VALUES ('9','计算机科学与技术（非师范）1班',NULL,NULL,'30','5','2010',NULL,NULL,NULL);
INSERT INTO `class` VALUES ('12','计算机科学与技术（非师范）1班',NULL,NULL,'30','6','2011',NULL,'4','2012-10-22');
...
INSERT INTO `class` VALUES ('17','计算机科学与技术（师范）1班','6','5','30','5','2009',NULL,'4','2012-10-22');
INSERT INTO `class` VALUES ('19','计算机科学与技术（师范）1班','5','6','30','1','2011',NULL,'4','2012-10-22');
INSERT INTO `class` VALUES ('22','物联网1班',NULL,NULL,'30','3','2009',NULL,'4','2012-10-22');
INSERT INTO `class` VALUES ('23','物联网2班','6','7','30','3','2010',NULL,'4','2012-10-22');
INSERT INTO `class` VALUES ('24','物联网1班',NULL,NULL,'30','4','2011',NULL,'4','2012-10-22');
...
INSERT INTO `class` VALUES ('29','网络信息安全','5','5','30','2','2009',NULL,'4','2012-10-22');
INSERT INTO `class` VALUES ('30','网络信息安全','7','6','30','6','2010',NULL,'4','2012-10-22');
INSERT INTO `class` VALUES ('31','网络信息安全','6','5','30','1','2011',NULL,'4','2012-10-22');
...
INSERT INTO `class` VALUES ('35','人工智能','6','5','30','1','2010',NULL,'4','2012-10-22');
INSERT INTO `class` VALUES ('36','人工智能','6','5','30','3','2011',NULL,'4','2012-10-22');
INSERT INTO `class` VALUES ('37','软件工程','5','6','30','6','2009',NULL,'4','2012-10-22');
INSERT INTO `class` VALUES ('38','软件工程','5','6','30','1','2010',NULL,'4','2012-10-22');
...
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='系统配置';

-- 
-- 导出`config`表中的数据 `config`
--
INSERT INTO `config` VALUES ('1','1','site_name','网站名称','西北师大教务支持系统','1');
INSERT INTO `config` VALUES ('2','1','site_url','网站网址','http://localhost/jwzcxt','1');
INSERT INTO `config` VALUES ('3','1','logo','网站LOGO','./Public/Images/logo.gif','1');
INSERT INTO `config` VALUES ('4','1','site_email','站点邮箱','1','1');
INSERT INTO `config` VALUES ('5','1','seo_title','网站标题','西北师大教务支持系统','1');
INSERT INTO `config` VALUES ('6','1','seo_keywords','关键词','http://localhost/jwzcxt','1');
INSERT INTO `config` VALUES ('9','4','attach_maxsize','允许上传附件大小','5200000','0');
INSERT INTO `config` VALUES ('10','4','attach_allowext','允许上传附件类型','jpg,jpeg,gif,png,doc,docx,rar,zip,swf','0');
INSERT INTO `config` VALUES ('11','4','watermark_enable','是否开启图片水印','1','0');
INSERT INTO `config` VALUES ('12','4','watemard_text_size','文字大小','18','0');
INSERT INTO `config` VALUES ('13','4','watemard_text_face','字体','elephant.ttf','0');
INSERT INTO `config` VALUES ('14','4','watermark_minwidth','图片最小宽度','300','0');
INSERT INTO `config` VALUES ('15','3','member_register','允许新会员注册','1','1');
INSERT INTO `config` VALUES ('16','3','member_registecheck','新会员注册需要审核','1','1');
INSERT INTO `config` VALUES ('17','3','member_login_verify','注册登陆开启验证码','1','1');
INSERT INTO `config` VALUES ('18','2','allow_add_graduation_thesis_title','允许添加毕业论文选题','1','1');
INSERT INTO `config` VALUES ('19','2','allow_add_term_thesis_title','允许添加学年论文选题','1','1');
INSERT INTO `config` VALUES ('20','2','autumn_semester','秋季学期','2','1');
INSERT INTO `config` VALUES ('21','2','default_start_week','默认起始授课周','1','1');
INSERT INTO `config` VALUES ('22','2','default_teach_week','默认授课周数','18','1');
INSERT INTO `config` VALUES ('23','2','graduation_thesis','毕业论文','2','1');
INSERT INTO `config` VALUES ('24','2','not_limit_major','不限专业','6','1');
INSERT INTO `config` VALUES ('25','2','role_type_teacher','教师角色','4','1');
INSERT INTO `config` VALUES ('26','2','spring_semester','春季学期','1','1');
INSERT INTO `config` VALUES ('27','2','term_thesis','学年论文','1','1');
INSERT INTO `config` VALUES ('28','2','thesis_result_failed','论文审核未通过','3','1');
INSERT INTO `config` VALUES ('29','2','thesis_result_pass','论文审核通过','2','1');
INSERT INTO `config` VALUES ('30','2','thesis_result_wait','论文待审核','1','1');
INSERT INTO `config` VALUES ('31','2','thesis_title_assign_teacher_model','论文题目指定教师模式','2','1');
INSERT INTO `config` VALUES ('32','2','thesis_title_free_select_model','论文题目自由选题模式','1','1');
INSERT INTO `config` VALUES ('33','2','user_title_select_model','使用的论文选题模式','1','1');
INSERT INTO `config` VALUES ('34','2','not_limit_admission','不限年级','0','1');
INSERT INTO `config` VALUES ('42','2','allow_student_select_graduation_thesis','允许学生选择毕业论文','1','0');
INSERT INTO `config` VALUES ('43','2','allow_student_select_term_thesis','允许学生选择学年论文','1','0');
INSERT INTO `config` VALUES ('44','2','undergraduate','本科生','1','0');
INSERT INTO `config` VALUES ('45','2','graduate','研究生','2','0');
INSERT INTO `config` VALUES ('46','2','doctoral','博士生','3','0');
INSERT INTO `config` VALUES ('51','2','finish_status_past','授课状态已授','1','0');
INSERT INTO `config` VALUES ('52','2','finish_status_now','授课状态在授','2','0');
INSERT INTO `config` VALUES ('53','2','finish_status_future','授课状态拟授','3','0');
--
-- 表的结构 `course`
-- 
...
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=utf8 COMMENT='课程';
...
INSERT INTO `course` VALUES ('3','密码学','1','2','1','1','2','2','10','6','1','6','100','0',NULL,'4','2012-10-23');
INSERT INTO `course` VALUES ('4','微积分','1','1','1','1','2','1','10','0','1','18','100','0',NULL,NULL,'2012-10-11');
INSERT INTO `course` VALUES ('5','网络信息安全','4','1','1','2','2','1','4','5',NULL,'5',NULL,'0',NULL,NULL,'2012-10-11');
...
INSERT INTO `course` VALUES ('142','test','1','1','1','1','1','1','5','5',NULL,'5',NULL,'0',NULL,NULL,NULL);
--
-- 表的结构 `course_change`
-- 
...
INSERT INTO `data_dict` VALUES ('config','type','1','站点配置','2','1','站点配置','4','2012-11-07');
INSERT INTO `data_dict` VALUES ('config','type','2','系统参数','2','2','系统参数','1','2012-11-07');
INSERT INTO `data_dict` VALUES ('config','type','3','用户中心设置','2','1','用户中心设置','1','2012-11-07');
INSERT INTO `data_dict` VALUES ('config','type','4','附件设置','2','4','附件设置','1','2012-11-07');
...
INSERT INTO `data_dict` VALUES ('thesis','state','1','未选题目','1','1','学生论文未选题目状态','2','2012-11-07');
INSERT INTO `data_dict` VALUES ('thesis','state','2','等待教师审核','1','2','学生论文等待教师审核状态','2','2012-11-07');
INSERT INTO `data_dict` VALUES ('thesis','state','3','教师审核通过','1','3','学生论文教师审核通过状态','2','2012-11-07');
INSERT INTO `data_dict` VALUES ('thesis','state','4','教师审核不通过','1','4','','2','2012-11-07');
...
--
INSERT INTO `major` VALUES ('1','计算机科学与技术','2','1','5','4',NULL,NULL,NULL,'9','2012-11-08');
...
INSERT INTO `major` VALUES ('4','智能科学与技术','2','2','5',NULL,NULL,NULL,NULL,NULL,NULL);
...
--
INSERT INTO `major_year` VALUES ('1','2002');
...
INSERT INTO `major_year` VALUES ('2009','2001');
--
-- 表的结构 `menu`
-- 
...
) ENGINE=InnoDB AUTO_INCREMENT=172 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 COMMENT='菜单';
...
INSERT INTO `menu` VALUES ('30','29','站点配置','1','','1','Config','index','1','','1','2012-11-07');
INSERT INTO `menu` VALUES ('31','29','数据库管理','1','','1','Database','index','2','','4','2012-11-07');
...
INSERT INTO `menu` VALUES ('38','34','本科生','2','type=undergraduate','1','Student','index','1','','9','2012-11-09');
INSERT INTO `menu` VALUES ('39','34','研究生','2','type=graduate','1','Student','index','2','','9','2012-11-09');
INSERT INTO `menu` VALUES ('40','34','博士生','2','type=doctoral','1','Student','index','3','','9','2012-11-09');
...
INSERT INTO `menu` VALUES ('47','23','班级管理','2','','1','Class','index','1','','9','2012-11-08');
INSERT INTO `menu` VALUES ('48','47','管理班级','2','','1','Class','index','1','','9','2012-11-08');
INSERT INTO `menu` VALUES ('49','47','奖学金评定','2','','1','Award','index','2','','9','2012-11-09');
INSERT INTO `menu` VALUES ('50','47','助学金评定','2','','1','Award','index','3','','9','2012-11-09');
INSERT INTO `menu` VALUES ('51','47','其它资助金','2','','1','Award','','4','','9','2012-11-09');
INSERT INTO `menu` VALUES ('55','24','排课管理','2','','1','in','','2','',NULL,NULL);
INSERT INTO `menu` VALUES ('56','55','理论和实践课','2','','1','ArrangeCourse','','1','',NULL,NULL);
INSERT INTO `menu` VALUES ('57','132','学年论文','2','category=1','1','ThesisTitle','','2','','9','2012-11-07');
INSERT INTO `menu` VALUES ('58','132','毕业论文','2','category=2','1','ThesisTitle','','3','','9','2012-11-07');
...
INSERT INTO `menu` VALUES ('74','69','管理专业','2','','1','Major','index','1','','9','2012-11-08');
INSERT INTO `menu` VALUES ('75','70','学院快讯','2','','1','Notice','index','1','','9','2012-11-08');
INSERT INTO `menu` VALUES ('76','70','学术活动','2','','1','Index','','2','',NULL,NULL);
INSERT INTO `menu` VALUES ('77','71','教师规模','2','','1','Index','','1','',NULL,NULL);
INSERT INTO `menu` VALUES ('78','71','部门机构','2','','1','Organize','index','2','','9','2012-11-09');
...
INSERT INTO `menu` VALUES ('82','73','修改密码','1','','1','tTeacher','pwd','2','','4','2012-11-07');
INSERT INTO `menu` VALUES ('83','2','论文管理','3','','1','Index','','1','','4','2012-10-26');
INSERT INTO `menu` VALUES ('84','83','学年论文','3','category=1','1','ThesisTitle','index','1','','5','2012-11-07');
INSERT INTO `menu` VALUES ('85','83','毕业论文','3','category=2','1','ThesisTitle','index','2','','5','2012-11-07');
...
INSERT INTO `menu` VALUES ('102','101','学年论文','4','category=1','1','ThesisTitle','mythesis','1','','2','2012-11-07');
INSERT INTO `menu` VALUES ('103','101','毕业论文','4','category=2','1','ThesisTitle','mythesis','2','','2','2012-11-07');
...
INSERT INTO `menu` VALUES ('122','121','院系公告','3','','1','tTeacher','notice','1','','5','2012-11-08');
...
INSERT INTO `menu` VALUES ('160','157','课程过渡','10','','1','CourseManage','transition','1','','11','2012-11-07');
...
INSERT INTO `menu` VALUES ('163','157','课程管理','10','','1','CourseManage','now_course_manage','2','','11','2012-11-07');
...
INSERT INTO `menu` VALUES ('168','73','个人资料','1','','1','tTeacher','info','1','','4','2012-11-07');
INSERT INTO `menu` VALUES ('170','160','恢复过渡','10','','1','CourseManage','recover','2','','11','2012-11-08');
INSERT INTO `menu` VALUES ('171','69','专业开设','2','','1','Major','yearmajor','2','','9','2012-11-08');
--
-- 表的结构 `node`
-- 
...
INSERT INTO `notice` VALUES ('3','1','附属教育集团','西北师范大学附属中和学校校长、副校长招聘启事','西北师范大学附属中和学校是一所按省级示范高中标准规划建设的学校，是定西市委、市政府重点招商引资项目。由兰州中和教育投资管理有限公司投资创办，西北师范大学附属教育集团管理运行的一所全日制民办公助高级中学。学校坐落于定西市新城区中心，占地100余亩，建筑面积6万平方米，总投资2.2亿元。目前学校正在建设中，现面向社会招聘校长和副校长各一名。\r\n一、招聘条件\r\n1．思想政治素质高，品德良好，热爱教育事业，有强烈的改革意识和开拓创新精神；具有履行校长职责所必备的政治理论、专业知识、工作经验、教育科研能力、组织领导和沟通协调能力；认真执行党的教育方针，遵纪守法，清正廉洁，有较强的民主意识和法治观念。\r\n2．符合《全国中小学校长任职条件和岗位要求》（试行）规定的基本任职条件，具备国民教育大学本科以上学历；具备高级中学教师资格，中学高级教师专业技术职称；具有高级中学5年以上校级干部岗位任职经历。\r\n3．应聘者年龄在60周岁以下，身体健康。\r\n4．具有民办学校工作经历者优先录用。\r\n二、薪酬待遇\r\n（一）校长\r\n1．受聘校长年薪包括“基本年薪”和“奖励年薪”两部分，建立动态增长机制，基本年薪30—60万元。\r\n2．可办理调动手续。\r\n3．配专车。\r\n4．连续工作满五年奖励120㎡住房一套。\r\n5．享受学校规定的相关福利，职称评定与公办学校相同。\r\n（二）副校长应聘条件和待遇面议。\r\n三、报名方式\r\n1、网上报名。应聘者请在西北师范大学网站（http://www.nwnu.edu.cn/）或在兰州中和集团网站（http://www.lzzhonghe.cn/）下载《应聘报名表》，填好后务必于2012年12月16日前将《应聘报名表》发至邮箱fsjyjt@163.com。\r\n2、请将以下材料复印件于2012年12月16日前邮寄至西北师范大学附属教育集团（甘肃省兰州市安宁区安宁东路 967号）（以当地邮戳时间为准）。\r\n（1）《西北师范大学附属中和学校校长、副校长应聘报名表》。\r\n（2）身份证、毕业证书、学位证书、校级领导聘书（任命书）、专业技术职称证（技术等级证）、教师资格证等复印件（A4纸）。\r\n（3）两寸正面彩色照片2张及五寸全身照1张。\r\n（4）相关业绩材料、证件复印件（A4纸）。\r\n3、报名时间：2012年10月16日——12月16日\r\n4、联系方式：\r\n西北师范大学附属教育集团联系电话：\r\n0931—7970901      （王老师 彭老师）\r\n兰州中和集团联系电话： \r\n0931—2119832        13893487630      （葛老师 刘老师）\r\n传    真：0931—7970901       \r\nE-mail：fsjyjt@163.com\r\n通讯地址：甘肃省兰州市安宁区安宁东路 967号（西北师范大学附属教育集团）\r\n邮政编码：730070\r\n5、初选合格者，将电话通知参加面试。应聘面试时，请带齐相应的证件原件。','2','1','2','9','2012-11-08');
--
-- 表的结构 `organize`
-- 
...
INSERT INTO `score` VALUES ('3','30','1',NULL,NULL);
INSERT INTO `score` VALUES ('3','31','1',NULL,NULL);
INSERT INTO `score` VALUES ('3','32','1',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='教学计划';
...
INSERT INTO `teach_plan` VALUES ('24','2','1','','4','富士达',NULL,NULL,'4','','2012-11-02','5','2012-11-07');
INSERT INTO `teach_plan` VALUES ('25','97','1','','4','sdfsdf',NULL,NULL,'4','dsfds','2012-11-08','5','2012-11-07');
--
-- 表的结构 `teach_task`
-- 
...
CREATE TABLE `teach_task` (
  ...
  `teacher_approval_comment` text COMMENT '教师认同授课结果',
  `operator` int(10) unsigned DEFAULT NULL COMMENT '操作员',
  `update_date` date DEFAULT NULL COMMENT '操作日期',
  PRIMARY KEY (`teachid`),
  KEY `i_pk_userid` (`userid`),
...
--
INSERT INTO `teach_task` VALUES ('1','5','1','2012','1','1','18',NULL,'1',NULL,'C++ primer','人民邮电出版社','stanley B.lippman','2012-11-01','5','2','1',NULL,NULL,NULL,NULL,'2',NULL,'5','2012-11-08');
INSERT INTO `teach_task` VALUES ('2','5','2','2012','1','1','18',NULL,'1',NULL,'计算机网络','','谢希仁','2012-11-07','5','test','test',NULL,NULL,NULL,NULL,'2',NULL,'5','2012-11-07');
INSERT INTO `teach_task` VALUES ('96','5','2','2013','1','1','18',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3','十分大方','9','2012-10-22');
INSERT INTO `teach_task` VALUES ('97','5','3','2012','2','2','17',NULL,'1',NULL,'程序设计','高等教育出版社','张晨曦','2008-06-04','1','与以往以往并无创新','程序设计艺术',NULL,NULL,NULL,NULL,'2',NULL,'5','2012-11-07');
INSERT INTO `teach_task` VALUES ('98','5','3','2008','1','3','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1',NULL,NULL,NULL);
INSERT INTO `teach_task` VALUES ('104','6','48','2013','1','1','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2',NULL,'9','2012-10-27');
INSERT INTO `teach_task` VALUES ('105','6','49','2013','1','1','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3',NULL,'9','2012-10-27');
INSERT INTO `teach_task` VALUES ('118','6','23','2013','1','1','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3',NULL,'9','2012-10-27');
INSERT INTO `teach_task` VALUES ('122','6','39','2013','1','1','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3',NULL,'9','2012-10-28');
INSERT INTO `teach_task` VALUES ('125','7','13','2013','1','1','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2',NULL,NULL,NULL,NULL,'3',NULL,NULL,'2012-10-29');
INSERT INTO `teach_task` VALUES ('136','5','48','2013','1','1','18',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3','方法',NULL,'2012-10-29');
INSERT INTO `teach_task` VALUES ('137','7','48','2013','1','1','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3',NULL,NULL,'2012-10-29');
INSERT INTO `teach_task` VALUES ('139','5','12','2013','1','1','18',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3','我很喜欢上这门可','9','2012-11-04');
INSERT INTO `teach_task` VALUES ('141','6','28','2013','1','1','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3',NULL,NULL,'2012-10-29');
INSERT INTO `teach_task` VALUES ('142','5','28','2013','1','1','18',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3','宝宝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝贝',NULL,'2012-10-29');
INSERT INTO `teach_task` VALUES ('143','5','78','2013','1','1','18',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'3',NULL,NULL,'2012-11-04');
--
-- 表的结构 `teach_time`
-- 
...
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='论文选题';
...
INSERT INTO `thesis_title` VALUES ('22','5','标题','1234564','1','5','0','1','不通过','2','2010','1','1','5','2012-11-07');
...
INSERT INTO `thesis_title` VALUES ('39','5','测试题目','这个是题目与要求题目内容与要求','1','5','0','2','不想通过','1','2009','1','1','9','2012-11-07');
...
INSERT INTO `thesis_title` VALUES ('44','5','学年论文测试题目','学年论文测试题目题目内容与要求','1','5','0','2','速度发','1','2009','1','1','9','2012-11-07');
INSERT INTO `thesis_title` VALUES ('45','5','测试题目','水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得O(∩_∩)O哈哈~ 水电费离开速度进来看风景sdk了就菲利克斯觉得','1','4','0','2','阿斯顿发送','1','2009','1','1','9','2012-11-07');
--
-- 表的结构 `workload`
-- 
